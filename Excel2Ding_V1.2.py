...
def create_gui():
    ...
    style.configure('TLabel', 
                   font=('Microsoft YaHei UI', 10),  # 改用微软雅黑UI
                   padding=5,
                   background=BG_COLOR)
    ...
    style.configure('TLabelframe.Label',
                   font=('Microsoft YaHei UI', 11, 'bold'),  # 改用微软雅黑UI
                   foreground=PRIMARY_COLOR,
                   background=BG_COLOR)
    style.configure('Modern.TButton',
                   font=('Microsoft YaHei UI', 10, 'bold'),  # 改用微软雅黑UI
                   padding=10,
...
3、请将【发起时间】单元格格式调整为【文本】"""
    ...
    input_entry = ttk.Entry(input_frame, width=50, font=('Microsoft YaHei UI', 10))  # 改用微软雅黑UI
    ...
    output_entry = ttk.Entry(output_frame, width=50, font=('Microsoft YaHei UI', 10))  # 改用微软雅黑UI
